...
function Menu() {
  ...
  return (
    <>
      <nav className="bg-menuBackGroundColor p-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <h2 className="text-menuTextColor text-3xl font-bold">Collers</h2>
          </div>
          <div className="hidden md:flex space-x-4">
            <button className="py-3 px-2 text-menuTextColor font-medium">
              Products
            </button>
            <button className="py-3 px-2 text-menuTextColor font-medium">
              Solutions
        ...
        {isOpen && (
          <div className="md:hidden mt-2 flex flex-col items-center">
            <button className="block py-3 px-2 text-menuTextColor font-medium">
              Products
            </button>
            <button className="block py-3 px-2 text-menuTextColor font-medium">
              Solutions
