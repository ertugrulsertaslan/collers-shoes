...
function SectionBecause() {
  ...
  return (
    <>
      <div className="w-full bg-sectionWhyBgColor p-5 xl:p-14 2xl:p-14 flex flex-wrap justify-between">
        <div className="mt-20">
          <h2 className="w-full 2xl:w-full text-4xl 2xl:text-6xl font-extrabold">
      ...
      <div className="w-full h-auto bg-white flex flex-col items-center justify-center relative overflow-hidden top-0 mb-20">
            ...
            return (
              ...
              >
                <div className="w-full flex">
                  ...
                  <div>
                    <h2 className="mb-5 text-2xl text-sectionBecauseTextColor font-bold">
                      {cardlist[dataIndex].workplace}
                    </h2>
                  </div>
                </div>

                <p className="text-lg 2xl:text-2xl h-42 font-normal">
                  {cardlist[dataIndex].review}
                </p>

                <div className="flex items-center mt-8">
                  <div className="mr-5">
                    <img
                      src={cardlist[dataIndex].img}
                      alt="profile"
                  ...
                  <div className="mt-4 mb-2">
                    ...
                    <p className="text-sectionBecauseTextColor text-base">
                      {cardlist[dataIndex].job}
                    </p>
                  </div>
                </div>
              </div>
